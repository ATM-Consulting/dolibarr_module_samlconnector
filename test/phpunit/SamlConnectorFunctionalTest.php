...
/**
 * \file    test/phpunit/SamlConnectorFunctionalTest.php
...
/**
 * Class SamlConnectorFunctionalTest
 *
 ...
 *
 * @package Testsamlconnector
 */
class SamlConnectorFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modSamlConnector')->click();
		} else {
			// Disable the module
			$this->byHref('modSamlConnector')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/samlconnector/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('samlconnector/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/samlconnector/admin/about.php');
		$this->authenticate();
		return $this->assertContains('samlconnector/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('samlconnectorwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modSamlConnector_SamlConnectorTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modSamlConnector_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
